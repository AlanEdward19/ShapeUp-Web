...
export function GymsExploreChrome({
  ...
  return (
    <div data-gym-page className="flex-1 flex flex-col h-screen min-w-0 overflow-hidden">
      <header className="h-auto border-b border-[#3a2d27] bg-[#211a17] px-6 py-3 shrink-0 flex flex-col gap-3">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2 flex-1 max-w-2xl">
            <div className="relative flex-1">
              <span className="material-symbols-outlined absolute left-3 top-2.5 text-[#b8aaa2] text-lg">search</span>
              <input
                className="w-full bg-[#171311] border border-[#3a2d27] rounded-md pl-9 pr-4 py-2 text-sm text-[#f3eae5] placeholder:text-stone-500 focus:outline-none focus:border-[#e06c43] transition-colors"
            ...
            <div className="relative shrink-0 flex items-center">
              ...
              <select
                className="bg-[#171311] border border-[#3a2d27] rounded-md pl-8 pr-8 py-2 text-xs font-medium text-[#f3eae5] appearance-none focus:outline-none focus:border-[#e06c43] cursor-pointer"
              ...
              <span className="material-symbols-outlined absolute right-2 text-[#b8aaa2] text-sm pointer-events-none">
                expand_more
              </span>
            </div>
            <div className="relative shrink-0 flex items-center">
              <select
                className="bg-[#171311] border border-[#3a2d27] rounded-md px-3 py-2 text-xs font-medium text-[#f3eae5] appearance-none focus:outline-none focus:border-[#e06c43] cursor-pointer"
              ...
              <span className="material-symbols-outlined absolute right-1.5 text-[#b8aaa2] text-sm pointer-events-none">
                expand_more
              </span>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <span className="text-xs text-[#b8aaa2] hidden sm:inline">
              <strong className="text-[#f3eae5] font-semibold">18 unidades</strong> encontradas
            </span>
            <button
              type="button"
              className="flex items-center gap-1.5 px-3 py-2 bg-[#29211d] hover:bg-[#3a2d27] border border-[#3a2d27] rounded-md text-xs font-medium text-[#f3eae5] transition-colors"
            >
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-0.5 custom-scroll text-nowrap text-xs">
          <span className="text-[#b8aaa2] text-[11px] font-medium pr-1">Filtros:</span>
          <button
            type="button"
          ...
          <button
            type="button"
            className="px-2.5 py-1 rounded-full bg-[#29211d] hover:bg-[#3a2d27] text-[#b8aaa2] hover:text-[#f3eae5] border border-[#3a2d27] font-medium flex items-center gap-1 transition-colors"
          >
