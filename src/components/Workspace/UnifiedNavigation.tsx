...
export default function UnifiedNavigation({ flow, open, close }: UnifiedNavigationProps): ReactElement {
  ...
  const items: NavItem[] = [
    ...
    ...(pro
      ? ([
          ['assessment', 'Relatórios', '/dashboard/reports'],
          ['monitoring', 'Análises', '/dashboard/analytics'],
        ] as NavItem[])
      : ([['target', 'Meus Objetivos', '/dashboard/objectives']] as NavItem[])),
    ...
    ...(role === 'gym'
      ? ([
          ['groups', 'Equipe', '/dashboard/staff'],
          ['sensor_door', 'Controle de Acesso', '/dashboard/turnstile'],
        ] as NavItem[])
      : []),
        ...
        <div className="sn-brand">
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <a href="/dashboard" aria-label="ShapeUp — Dashboard" onClick={close} style={{ padding: 0, border: 0 }}>
              <Logo variant="lockup" width="142" height="34" style={undefined} />
            </a>
          </div>
