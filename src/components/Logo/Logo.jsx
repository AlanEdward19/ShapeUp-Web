...
export default function Logo({ className = '', variant = 'mark', monochrome = false, style, ...props }) {
  ...
  return <svg xmlns="http://www.w3.org/2000/svg" viewBox={variant === 'lockup' ? '0 0 1510 380' : variant === 'stacked' ? '80 80 1120 1110' : '110 80 1030 800'} preserveAspectRatio="xMidYMid meet" className={className} role="img" aria-label="ShapeUp" style={{ '--logo-primary': dark ? '#e06c43' : '#c84c2b', '--logo-accent': dark ? '#f3dfaa' : '#544237', '--logo-wordmark': dark ? 'var(--text-main)' : '#211a17', display: 'block', flexShrink: 0, ...style }} {...props}>
